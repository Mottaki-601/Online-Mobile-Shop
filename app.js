...
app.post("/save-product", async (req, res) => {
  ...
  // Broadcast new product to all connected clients via Socket.io
  const productData = {
    _id: prodModel._id.toString(),
    name: prodModel.name,
    price: prodModel.price,
    description: prodModel.description,
    picture: prodModel.picture,
    categoryid: prodModel.categoryid,
    subcategoryid: prodModel.subcategoryid,
    featured: prodModel.featured
  };
